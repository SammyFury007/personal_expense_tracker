...
Created as a Personal Expense Tracker Mini Project for Qubitedge Internship Program

---

## 📞 Support & Questions

For questions or issues, please reach out to the project team.

---

## 🙏 Acknowledgments

- Qubitedge Internship Program
- Python community
...
**Technologies:** Python, SQLite, Matplotlib, Pandas  
...
- Multiple users can have separate expense records
- Expenses are never deleted (for audit trail)
- All calculations are done in real-time from database
- Charts are generated on-demand for memory efficiency
